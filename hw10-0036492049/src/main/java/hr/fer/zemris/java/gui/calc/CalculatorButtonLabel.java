...
/**
 * Class that represents calculator button as a label
 *
 * @author Pavao Jerebić
 */
public class CalculatorButtonLabel extends JLabel {
    /**
     ...
     */
    public CalculatorButtonLabel(String s) {
        super(s);
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawString(
                str,
                (dim.width - ins.left - ins.right - v) / 2 + ins.left,
